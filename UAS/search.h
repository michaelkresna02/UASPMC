...
void searching(){
    ...
    printf("No.\tNIK\t\tNama\t\tTmptLhr\tTglLhr\t\tUmur\tJns Klm\tGolDar\tStatus\tPekerjaan\n");
        ...
        i++;
            ...
            while(i<count && strcmp(r,data[i].tempat)!=0){
            i++;
            found==1;
            }
        }
        else if(n==4){
            while(i<count && strcmp(r,data[i].tanggal)!=0){
            i++;
            found==1;
            }
        }
            ...
            while(i<count && strcmp(r,data[i].kelamin)!=0){
            i++;
            found==1;
            }
        }
        else if(n==7){
            while(i<count && strcmp(r,data[i].gol)!=0){
            i++;
            found==1;
            }
        }
        else if(n==8){
            while(i<count && strcmp(r,data[i].status)!=0){
            i++;
            found==1;
            }
        }
        else if(n==9){
            while(i<count && strcmp(r,data[i].pekerjaan)!=0){
            i++;
            found==1;
            }
        }
